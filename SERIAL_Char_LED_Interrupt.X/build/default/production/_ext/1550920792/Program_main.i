# 1 "../SERIAL_Char_LED.X/Program_main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../SERIAL_Char_LED.X/Program_main.c" 2
...
# 63 "../SERIAL_Char_LED.X/Program_main.c" 2

# 1 "../SERIAL_Char_LED.X/eusart.h" 1
...
# 64 "../SERIAL_Char_LED.X/Program_main.c" 2
...
void __attribute__((picinterrupt(("")))) half_Duplex(void)
{
    if(PIR1bits.RCIF == 1)
    {
      data[0] = eusart_read();
